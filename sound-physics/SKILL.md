---
name: sound-physics
description: Ground practical acoustics decisions in real physics — wave propagation, room modes/standing waves, absorption vs. diffusion, Helmholtz resonance, inverse-square law, near/far field, speaker and mic directivity, and phase/comb filtering when summing mics. Use whenever Dawid is placing acoustic panels or bass traps, positioning a mic on a cab/drum/room, placing or aiming monitors, reading a REW frequency-response graph, reasoning about a room mode or a dip/peak in a measurement, choosing two-mic spacing, or asking "why does it sound like X here" about the kanciapa room — even without saying "acoustics", e.g. "where should the bass trap go", "why is there a null here", "will these two mics cancel out". Physical counterpart to av-signal-chain (electrical grounding, gain staging, buffers).
---
